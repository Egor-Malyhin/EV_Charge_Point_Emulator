...
public class EVCommunicationBlockSessionHandler extends IoHandlerAdapter implements EVCommunicationBlockInterface {
    ...
    private V2GMessage getFaultedMessage(String messageType) {
        return switch (messageType) {
            case "SessionStopReq" ->
                    V2GMessageResFactory.createSessionStopResMessage(null, ResponseCode.FAILED_UnknownSession);
            case "ChargeParameterDiscoveryReq" ->
                    V2GMessageResFactory.createChargeParameterDiscoveryResMessage(null, ResponseCode.FAILED_UnknownSession, 0, 0);
            case "ChargingStatusReq" ->
                    V2GMessageResFactory.createChargingStatusRes(null, ResponseCode.FAILED_UnknownSession, null, null, 0, 0);
            case "PowerDeliveryReq" ->
                    V2GMessageResFactory.createPowerDeliveryRes(null, ResponseCode.FAILED_UnknownSession, null);
